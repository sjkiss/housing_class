...
ces$occupation_oesch_5<-factor(ces$occupation_oesch_5,
                               levels=c("Unskilled workers", "Skilled workers", "Self-employed", "Lower-grade service", "Higher-grade service"))
...
#Convert election to factor
ces$election<-as.factor(ces$election)

#Write out data set to two different files
